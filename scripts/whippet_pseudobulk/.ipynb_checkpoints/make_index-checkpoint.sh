...
# Run Whippet indexing
$JULIA_BIN $WHIPPET_PROJECT/bin/whippet-index.jl \
  --fasta /no_backup/jferrer/mplanas/VASAseq/files/hg38.fa \
  --gtf /no_backup/jferrer/jmidgley/VASAseq/jessies_HIT.gtf \
  -x /no_backup/jferrer/jmidgley/whippet/RERUN/index
###############
# end message #
###############
